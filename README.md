...
2. Скачайте `elementalstaves-1.1.1.jar` из релиза или соберите его сами.
...
Готовый файл появится в `build/libs/elementalstaves-1.1.0.jar`. GitHub Actions также собирает JAR на каждом push и pull request.
