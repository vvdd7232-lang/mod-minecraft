...
- Валы не наносят урон, не производят FE и пока не приводят в действие станки.
  Воронки и отдельное окно инвентаря не поддерживаются; загрузка ручная.
...
Готовый файл появится в `build/libs/elementalstaves-1.5.0.jar`.
